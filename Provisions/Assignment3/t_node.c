...
void set_t_node_data(t_node t, void *o)
{
	...
	t->data = o; // assign the data of t_node to the address of the game state
...
void set_t_node_left(t_node t, t_node n)
{
	...
	t->left = n; // assign the left vertex of t_node to another t_node
...
void set_t_node_middle(t_node t, t_node n)
{
	...
	t->middle = n; // assign the middle vertex of t_node to another t_node
...
void set_t_node_right(t_node t, t_node n)
{
	...
	t->right = n; // assign the right vertex of t_node to another t_node
...
void set_t_node_parent(t_node t, t_node n)
{
	...
	t->parent = n; // assign the parent vertex of t_node to another t_node
...
void *get_t_node_data(t_node t)
{
	...
	return t->data; // Returns the address of the game state
}
...
t_node get_t_node_left(t_node t)
{
	...
	return t->left; // returns t_node of the left vertex
}
...
t_node get_t_node_middle(t_node t)
{
	...
	return t->middle; // returns t_node of the middle vertex
}
 ...
 *				field returning its value
 *
 *	return t_node the right branch of the current node
 */
t_node get_t_node_right(t_node t)
{
	trace("get_t_node_right: get_t_node_right starts and ends");

	return t->right; // returns t_node of the right vertex
}
...
t_node get_t_node_parent(t_node t)
{
	...
	return t->parent; // returns t_node of the parent vertex
}
